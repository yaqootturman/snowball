...
;
 ...
 Insert into pledge
    (category_id,order_id,priority_id,pledge_short_description,title,description,number_of_enrollement, img ,banner_img, importance ,further_info)
  values
 (1,5,5,'Fly less','Flying','I will take no more than one return flight each year. When I do fly, I will offset my emissions.',4545,'https://i.imgur.com/dd6lk8b.jpg','https://i.imgur.com/dd6lk8b.jpg','Flying is very carbon intensive. Large planes burn over a gallon of fuel every second..
...
'),
(1,8,8,'Use Public transport','Public transport','I will take public transport instead of driving whenever I''m able to',7536,'https://i.imgur.com/G2nwFZT.jpg','https://i.imgur.com/G2nwFZT.jpg','Transport accounts for about a third of the UK''s carbon dioxide emissions and is the largest contributing sector in the country. Passenger cars and vans alone contribute around 17% of our emissions.. 
...
') ,(2,9,9,'Reduce home energy use','Reduce energy use','I will reduce my home energy use',5961,'https://i.imgur.com/7J0ZMp5.jpg','https://i.imgur.com/Ngsupoc.jpg','With household energy accounting for 30% of individual emissions, reducing your consumption is a simple way to reduce emissions and save you money..
...
(4,2,2,'Eat less meat','Meat eating','I will have more meat free days than meat eating days each week and will eat red meat no more than once a week
...
'),
(4,4,4,'Eat local and seasonal','Local, seasonal food','I will eat locally produced, seasonal food wherever I can',4562,'https://i.imgur.com/vGUvrQX.jpg','https://i.imgur.com/U9jjmaZ.jpg','Only 23% of fruit and vegetables eaten in Britain are grown in the UK.. 
